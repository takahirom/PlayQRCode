...
import com.google.zxing.client.result.SMSBarcode;
...
public final class SMSResultHandler extends ResultHandler {
  ...
  public SMSResultHandler(Activity activity, Barcode result) {
  ...
  public void handleButtonPress(int index) {
    SMSBarcode smsResult = (SMSBarcode) getResult();
  ...
  public CharSequence getDisplayContents() {
    ...
    Barcode.maybeAppend(formattedNumbers, contents);
    Barcode.maybeAppend(smsResult.getSubject(), contents);
    Barcode.maybeAppend(smsResult.getBody(), contents);
