...
import takahirom.github.com.playqrcode.ui.activity.QRDetailActivity;
...
public final class WifiResultHandler extends ResultHandler {
  ...
  private final QRDetailActivity parent;

  public WifiResultHandler(QRDetailActivity activity, Barcode result) {
  ...
  public void handleButtonPress(int index) {
    if (index == 0) {
      WifiBarcode wifiResult = (WifiBarcode) getResult();
