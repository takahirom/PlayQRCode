...
public final class URIResultHandler extends ResultHandler {
  ...
  public URIResultHandler(Activity activity, Barcode result) {
    super(activity, result);
  }

  @Override
  public int getButtonCount() {
    if (LocaleManager.isBookSearchUrl(getBarcode().url.url)) {
  ...
  public boolean areContentsSecure() {
    String uri = getBarcode().url.url.toLowerCase(Locale.ENGLISH);
