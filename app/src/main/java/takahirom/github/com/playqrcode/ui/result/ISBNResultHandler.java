...
import com.google.zxing.client.result.ISBNBarcode;
...
public final class ISBNResultHandler extends ResultHandler {
  ...
  public ISBNResultHandler(Activity activity, Barcode result, Result rawResult) {
  ...
  public void handleButtonPress(int index) {
    ISBNBarcode isbnResult = (ISBNBarcode) getResult();
    switch (index) {
      case 0:
